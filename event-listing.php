<!doctype html>
<html lang="en">
<?php include 'particials/header.php' ?>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="index.php#section_2">About</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="index.php#section_3">Membership</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="index.php#section_4">Events</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="index.php#section_5">Contact Us</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            ...
                            <div class="custom-block-info">
                                <a href="event-detail.php" class="events-title mb-2">Single Tournament</a>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="custom-block-info">
                                <a href="event-detail.php" class="events-title mb-2">Group Tournaments</a>
                        ...
                        <div class="row custom-block mb-3">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    <a href="event-detail.php" class="events-title mb-3">Private Golf Courses</a>
        ...
        <?php include "particials/footer.php"?>
